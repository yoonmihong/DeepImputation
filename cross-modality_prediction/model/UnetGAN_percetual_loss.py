...
class UnetGAN:
    def __init__(self,
        ...
        kernel_initializer = tf.function(kernel_initializer, autograph=False) 
    ...
    def model(self):
        ...
        # X
        input_x_40 = self.x[0:2, 120, :, :, :]
        input_x_30 = self.x[0:2, 100, :, :, :]
        input_x_20 = self.x[0:2, 90, :, :, :]
        input_x_10 = self.x[0:2, 80, :, :, :]

        input_y_40 = self.y[0:2, 120, :, :, :]
        input_y_30 = self.y[0:2, 100, :, :, :]
        input_y_20 = self.y[0:2, 90, :, :, :]
        input_y_10 = self.y[0:2, 80, :, :, :]

        x_generated = self.G(self.x)
        x_generated_40 = x_generated[0:2, 120, :, :, :]
        x_generated_30 = x_generated[0:2, 100, :, :, :]
        x_generated_20 = x_generated[0:2, 90, :, :, :]
        x_generated_10 = x_generated[0:2, 80, :, :, :]
